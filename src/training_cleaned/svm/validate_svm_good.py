...
def main():
    ...
    RAW_DATA_ROOT = Path(r"C:\DEV\personal\Ai-Driven-Vibrations-motor\data\raw_mafulda")
    CACHE_FILE = "mafaulda_physics_validated_13_Decimation_new_____2026_with_Severity_2.pkl"
    ...
    if COMPUTE_FEATURE_IMPORTANCE:
        compute_permutation_feature_importance(clf, X_test_scaled, y_test, feature_cols, class_names)
    ...
    joblib.dump(saved_pipeline, "svm_pipeline_physics_validated.pkl")
    logger.info("✅ Model saved to svm_pipeline_physics_validated.pkl")
